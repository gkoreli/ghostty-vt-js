...
//   https://github.com/coder/ghostty-web/blob/6a1a50df5b4f6b34d1b1de10fad3a0fc811bfbc0/lib/link-detector.ts
...
import type { IBufferCellPosition, ILink, ILinkProvider } from './types.js';
