...
//   https://github.com/coder/ghostty-web/blob/6a1a50df5b4f6b34d1b1de10fad3a0fc811bfbc0/lib/providers/url-regex-provider.ts
// Substantially rewritten since; this file is ours and does not track that project.
// Modified: typed activate(event: MouseEvent) (TS7006 fix).
...
import type { IBufferRange, ILink, ILinkProvider } from '../types.js';
